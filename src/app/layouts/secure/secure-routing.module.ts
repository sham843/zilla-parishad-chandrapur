...
const routes: Routes = [
  ...
  { path: 'student-profile', loadChildren: () => import('../../modules/dashboard/student-profile/student-profile.module').then(m => m.StudentProfileModule), data: { breadcrumb: [{ title: 'Student Profile', active: true }] }},
