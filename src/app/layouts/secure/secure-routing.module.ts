...
const routes: Routes = [
  ...
  { path: 'agency-master', loadChildren: () => import('../../modules/masters/agency-registration/agency-registration.module').then(m => m.AgencyRegistrationModule), data: { breadcrumb: [{ title: 'NGO Master', active: true }] }, canActivate: [ExpenseGuard] },
