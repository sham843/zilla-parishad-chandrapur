...
const routes: Routes = [
  ...
  { path: 'inspection-report-details', loadChildren: () => import('../../modules/reports/inspection-report/inspection-report-details/inspection-report-details.module').then(m => m.InspectionReportDetailsModule), data: { breadcrumb: [{ title: 'Inspection Report Details', active: true }] }, canActivate: [ExpenseGuard] },
