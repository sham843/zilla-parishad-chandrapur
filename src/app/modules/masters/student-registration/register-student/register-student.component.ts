...
export class RegisterStudentComponent {
  ...
  formData(data?: any) {
    this.studentFrm = this.fb.group({
      ...
      "talukaId": [data?.talukaId || (this.levelId == 1|| this.levelId == 2 ? 0 : this.loginData.talukaId), Validators.required],
      "centerId": [data?.centerId || (this.levelId == 1|| this.levelId == 2 ? 0 :  this.loginData.centerId), [Validators.required]],
      "schoolId": [data?.schoolId || (this.levelId == 1|| this.levelId == 2 ? 0 :  this.loginData.schoolId), [Validators.required]],
